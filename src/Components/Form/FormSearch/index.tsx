...
export const SFormSearchData = ({ selected, onChange, onclick }: PropsSearchDate) => {
    ...
    return (
        <Fragment>
            ...
            <div className="flex bg-white rounded-lg border border-gray-300 w-full focus:outline-none focus:border-indigo-400">
                <div
                ...
                <DatePicker
                    className="border-y-0 border-r-0 border-gray-300 focus:ring-0 focus:border-gray-300 text-md mr-2 h-10"
                    selected={selected}
                    onChange={onChange}
                    id="dataInicial"
                    name="dataInicial"
