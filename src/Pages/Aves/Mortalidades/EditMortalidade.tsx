...
const EditMortalidade = () => {
  const location = useLocation().state as MortalidadeProps;
      ...
      <ABoxAll>
        ...
        {!activeCiclo ? (
          ...
          <Formik
            ...
            onSubmit={onsubmit}
            initialValues={{
              idMortalidade: location.idMortalidade,
              cicloId: location.cicloId,
              loteId: location.loteId,
              aviarioId: location.aviarioId,
              dataMorte: location.dataMorte,
              causaMorte: location.causaMorte,
              outraCausa: location.outraCausa,
              ...
              totalFemeas: location.totalFemeas,
              totalMachos: location.totalMachos,
              totalAves: location.totalAves,
            }}
          >
