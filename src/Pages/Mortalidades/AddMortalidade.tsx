  ...
  return (
    <Fragment>
      ...
      <ABoxAll>
        ...
        {!activeCiclo
          ? <AMessageError className="rounded-t-lg">Para cadastrar mortalidades os ciclos deverão estar cadastrados e ativos</AMessageError>
          : <Formik
              ...
              <Form autoComplete="off" >
                ...
                <div className="bg-white rounded-t-lg border overflow-auto py-8 px-2">
                  ...
                  <div className="mt-0 mb-6 py-2 pl-2 rounded-t-md border-b-2 border-white shadow bg-blue-500">
                    <h1 className="font-lg text-white font-medium uppercase">Adicioanar mortalidade</h1>
                  </div>
                  ...
                  <div className="grid grid-cols-4 gap-8">
                    <div className="mt-4">
                      <label className="w-full mt-2 text-blue-800 font-medium" htmlFor="dataMorte">Data da morte</label>
                      <DatePickerField
                        className={`w-full px-4 py-2 text-gray-700 bg-gray-50 border border-gray-200 ${errors.dataMorte ? 'border-red-400' : 'border-gray-200'} rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:ring`}
                        id="dataMorte"
                        name="dataMorte"
                    ...
                    <div className="mt-4">
                      <label className="w-full mt-2 text-blue-800 font-medium" htmlFor="aviarioId">Causa da morte</label>
                      <Field
                        as="select"
                        className={`w-full px-4 py-2 text-gray-700 bg-gray-50 border ${errors.causaMorte ? 'border-red-400' : 'border-gray-200'} rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:ring`}
                        id="causaMorte"
                        name="causaMorte"
                        type="text"
                      >
                        ...
                        {causas.map((cm: any, icm: any) => (
                          <option key={icm} value={cm.idx}>{cm.causa}</option>
                        ))}
                      </Field>
                      {errors.causaMorte &&
                        <AMessageError className="rounded-b-lg">{errors.causaMorte}</AMessageError>
                      }
                    </div>
                  </div>
                  {values.causaMorte === "99" &&
                    <div className="mt-4">
                      <label className="w-full mt-2 text-blue-800 font-medium" htmlFor="outraCausa">Descreva a outra causa da morte</label>
                      <Field
                        className={`w-full px-4 py-2 text-gray-700 bg-gray-50 border border-gray-200 ${errors.outraCausa ? 'border-red-400' : 'border-gray-200'} rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:ring`}
                        id="outraCausa"
                        name="outraCausa"
                        component="textarea"
                        rows="2"
                      ...
                      />
                      {errors.outraCausa && 
                        <AMessageError className="rounded-b-lg">{errors.outraCausa}</AMessageError>
                      }
                    </div>
                  }
                  ...
                  <div className="flex items-center mb-6 mt-10 pt-1 pl-2 rounded-t-md border-b-2 border-l-8 border-blue-600">
                    <span className="text-gray-800 font-medium text-sm uppercase">Mortalidade de fêmeas</span>
                    {values.loteId &&
                  ...
                  <div className="flex mb-6 mt-10 pt-1 pl-2 rounded-t-md border-b-2 border-l-8 border-blue-600">
                    <span className="text-gray-800 font-medium text-sm uppercase">Mortalidade de machos</span>
                    {values.loteId &&
                      <div className="flex items-center animate__animated animate__fadeIn ">
                        <span className="ml-4 font-medium text-xs">Disponíveis</span>
                        <span className="text-blue-500 ml-1 font-medium text-sm px-2 rounded-t-lg">
                  ...
                  <div className="flex mb-6 mt-10 pt-1 pl-2 rounded-t-md border-b-2 border-l-8 border-blue-600">
                    <span className="text-gray-800 font-medium text-sm uppercase">Mortalidade de totais</span>
                  </div>
                  <div className="md:grid md:grid-cols-3 md:gap-8">
                    <div>
                      <label className="w-full mt-2 text-blue-800 font-medium" htmlFor="totalFemeas">Total fêmeas</label>
                      <Field
                        className={`w-full px-4 py-2 text-gray-700 bg-gray-50 border ${errors.totalFemeas ? 'border-red-400' : 'border-gray-200'} rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:ring`}
                        id="totalFemeas"
                        name="totalFemeas"
                        type="text"
                        onFocus={(e: any) => e.target.value}
                        value={values.totalFemeas =
                          (
                            parseInt(values.box1Femea ? values.box1Femea : '0') +
                            parseInt(values.box2Femea ? values.box2Femea : '0') +
                            parseInt(values.box3Femea ? values.box3Femea : '0') +
                      ...
                      />
                      {errors.totalFemeas &&
                        <AMessageError className="rounded-b-lg">{errors.totalFemeas}</AMessageError>
                      }
                    </div>
                    <div className="mt-4 md:mt-0">
                      <label className="w-full mt-2 text-blue-800 font-medium" htmlFor="totalMachos">Total machos</label>
                      <Field
                        className={`w-full px-4 py-2 text-gray-700 bg-gray-50 border ${errors.totalMachos ? 'border-red-400' : 'border-gray-200'} rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:ring`}
                        id="totalMachos"
                        name="totalMachos"
                        type="text"
                        onFocus={(e: any) => e.target.value}
                        value={values.totalMachos =
                          (
                            parseInt(values.box1Macho ? values.box1Macho : '0') +
                            parseInt(values.box2Macho ? values.box2Macho : '0') +
                            parseInt(values.box3Macho ? values.box3Macho : '0') +
                      ...
                      />
                      {errors.totalMachos &&
                        <AMessageError className="rounded-b-lg">{errors.totalMachos}</AMessageError>
                      }
                    </div>
                    <div className="mt-4 md:mt-0">
                      <label className="w-full mt-2 text-blue-800 font-medium" htmlFor="totalAves">Total à enviar</label>
                      <Field
                        className={`w-full px-4 py-2 text-gray-700 bg-gray-50 border ${errors.totalAves ? 'border-red-400' : 'border-gray-200'} rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:ring`}
                        id="totalAves"
                        name="totalAves"
                        type="text"
                        onFocus={(e: any) => e.target.value}
                        value={values.totalAves = values.totalFemeas ? values.totalFemeas : 0 + values.totalMachos ? values.totalMachos : 0}
                      />
                      {errors.totalAves &&
                        <AMessageError className="rounded-b-lg">{errors.totalAves}</AMessageError>
                      }
                    </div>
                  </div>
